...
def values(**changes: object) -> dict[str, object]:
    result: dict[str, object] = {"listen_host": "78.17.68.165", "listen_port": 18100, "database_path": "/var/lib/business-bridge-2-direct/bridge.sqlite3", "log_dir": "/var/log/business-bridge-2-direct", "service_name": "business-bridge-2-direct", "service_version": "0.9.1", **LIMITS}
...
class DirectServiceTests(unittest.TestCase):
    ...
    def test_version_and_valid_exact_config(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(config.load_config(path).service_version, "0.9.1")
    ...
    def _server(self, **changes: object):
        ...
        service = SimpleNamespace(database_path=str(path), service_name="business-bridge-2-direct", version="0.9.1", identity={"instance_id":"00000000-0000-4000-8000-000000000000", "signing_algorithm":"ECDSA_P256_SHA256", "public_key_format":"SPKI_DER_BASE64URL", "public_key_spki":"AQ", "fingerprint":"sha256:" + "0" * 64, "rotation_generation":1})
    ...
    def test_exact_public_contracts_headers_and_connection_close(self) -> None:
        ...
        try:
            for path, body in ((b"/v2/health", b'{"status":"ok","service":"business-bridge-2-direct","version":"0.9.1"}'), (b"/v2/version", b'{"service":"business-bridge-2-direct","version":"0.9.1","api_version":"v2","transport":"direct-http-bootstrap"}'), (b"/v2/diagnostics/public", b'{"service":"business-bridge-2-direct","version":"0.9.1","status":"ready","listener_scope":"public","database":"ready","identity":"ready","pairing":"enabled","crypto":"BB2D-P1","tasks":"enabled"}')):
