...
Текущий результат после публикации acceptance: `BB2-DIRECT-03 ACCEPTED / PASS`; следующий `BB2-DIRECT-04`. Direct пока не production-ready, слушает только localhost; public reachability ещё не выполнена.
